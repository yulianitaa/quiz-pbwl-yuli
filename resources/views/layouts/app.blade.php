...
<body style="background-color: rgb(223, 122, 122)">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: rgb(230, 196, 84)">
            <div class="container">
                <a class="navbar-brand text-light" href="{{ url('/') }}">
                    QUIZ PBWL YULIA IMANITA
                </a>
